...
public class Main {
    ...
    private static void processCommand(Scanner in, Robot r1, Robot r2){
    ...
    private static void processMove(Scanner in, Robot mainRobot, Robot otherRobot, int i){
        ...
        if (mainRobot.willCollide(otherRobot,distance,direction)){
            ...
            int moved = mainRobot.move(distance, direction, x, y, mainRobot.getAut());
    ...
    private static void processClosestWall(Robot mainRobot, Robot otherRobot){
        int direction = mainRobot.closestWall(otherRobot);
    ...
    private static void processReturnRobot(Robot mainRobot, Robot otherRobot, int i){
        ...
        if (mainRobot.robotReturn(otherRobot, mainRobot.getAut(), mainRobot.getX(), mainRobot.getY())){
